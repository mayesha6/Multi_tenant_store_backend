...
const sendAgentMessage = async (conversationId, tenantId, agentId, payload) => {
...
const getMessages = async (conversationId, tenantId, query) => {
    const conversation = await prisma.conversation.findFirst({
        where: {
            id: conversationId,
            tenantId,
...
const markAsSeen = async (conversationId, tenantId) => {
